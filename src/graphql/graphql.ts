...
export type QueryQuery = { __typename?: 'Query', players?: Array<{ __typename?: 'Player', deaths: number, foodEaten: number, kills: number } | null> | null, stats?: { __typename?: 'GlobalStats', botDeaths: number, botKills: number, botFoodEaten: number, playerDeaths: number, playerKills: number, playerFoodEaten: number } | null };
